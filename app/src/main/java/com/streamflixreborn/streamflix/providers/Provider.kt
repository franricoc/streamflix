...
interface Provider {
    ...
    companion object {
        ...
        val providers = mapOf(
            ...
            TlnovelasProvider to ProviderSupport(movies = false, tvShows = true),
            LamovieProvider to ProviderSupport(movies = true, tvShows = true),
            ...
            SuperFavoritesProvider to ProviderSupport(movies = true, tvShows = true)
        )
